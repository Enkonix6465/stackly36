        ...
        <section className="max-w-6xl mx-auto py-16 px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                <span className="text-5xl mb-4 text-blue-700 dark:text-blue-200">
                  {service.icon}
                </span>
        ...
        <section className="bg-blue-50 dark:bg-gray-800 py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <ol className="relative border-l-4 border-blue-200 dark:border-blue-800 ml-4 space-y-10">
              <li className="ml-6">
                <div className="absolute  w-8 h-8 bg-blue-100 dark:bg-blue-900 border-4 border-blue-300 dark:border-blue-800 rounded-full -left-10    flex items-center justify-center text-2xl">
                  <ScrollText size={30} />
                </div>
